...
def _mock_flights(origin, destination, departure):
    return [FlightOption(airline="A airways",departure_time="2026-03-28 15:30", arrival_time="2026-03-28 21:30",price=1000.0,stops=0,booking_url="a-airways.com"),FlightOption(airline="B airways",departure_time="2026-03-28 10:30", arrival_time="2026-03-28 22:30",price=700.0,stops=1,booking_url="b-airways.com"),FlightOption(airline="C airways",departure_time="2026-03-28 15:30", arrival_time="2026-03-29 5:30",price=500.0,stops=2,booking_url="c-airways.com")]
...
def _mock_activities(destination, preferences):
    return [ActivityOption(name="Mount Climbing",category="outdoors",duration_hours=2.0,price=150.0,description="Mount Climbing"),ActivityOption(name="Horse Riding",category="outdoors",duration_hours=1.0,price=100.0,description="Horse Riding"), ActivityOption(name="Spa Treatment",category="indoors",duration_hours=3.0,price=300.0,description="Spa Treatment")]
